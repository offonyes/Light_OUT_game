...
class Turn_Light(tk.Frame):
    def __init__(self, master=None):
        ...
        text.place(x=1,y= 20)
        self.move = 0
        self.Moves = tk.Label(self, text=f"Moves\n{self.move}",width=4,height=2)
        self.Moves.grid(row = 6, column = 2 ,pady=(25,0))
        self.count = 0
    ...
    def createWidgets(self):
        ...
        self.QUIT = tk.Button(self, text="QUIT", fg="red",
                    command=root.destroy,width=4,height=2).grid(row = 2, column = 7 ,padx=(25,0))
